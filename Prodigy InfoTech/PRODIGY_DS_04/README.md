...
📁 Dataset
Dataset used: Twitter Training Dataset
...
Removed rows with missing tweets
Converted tweets to string format
...
Some brands receive more positive engagement than others
Negative sentiment is dominant for certain topics
Most tweets are short to medium in length
